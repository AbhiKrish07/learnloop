  ...
  return (
    <div className="learnloop-site">
      ...
      <main id="top">
        ...
        <section id="ipad-demo" className="workspace-section page-section">
          <div className="section-label"><span>02</span><span>PRODUCT SCREENS & MOCKUPS</span></div>
          <div className="workspace-heading">
            <h2>Explore the actual<br /><em>product interfaces.</em></h2>
            <p>Switch between screens and change device frames to see exactly how LearnLoop looks and feels in real proportions.</p>
          </div>
          <ScreenMockupStudio initialScreen="notebook" initialDevice="desktop" />
        </section>
